...
modelfile = "model/openchat_3.5-16k.Q4_K_M.gguf"
repetitionpenalty = 1.15
contextlength=16384
logfile = 'openchat_3_5-16k-GGUF-promptsPlayground.txt'
print("loading model...")
stt = datetime.datetime.now()
conf = AutoConfig(Config(temperature=0.3, repetition_penalty=repetitionpenalty, batch_size=64,
                max_new_tokens=2048, context_length=contextlength, stop=['<|end_of_turn|>']))
...
def combine(a, b, c, d):
    ...
    temperature = c
    max_new_tokens = d
    prompt = "GPT4 User: " + b + "<|end_of_turn|>\nGPT4 Assistant:"
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:   #theme=gr.themes.Glass()
    ...
    with gr.Row(variant='compact'):
            ...
            + "<h2>💬 OpenChat 3.5 16K context window</h2>"
    ...
    with gr.Row():
        ...
        with gr.Column(scale=4):
            txt = gr.Textbox(label="System Prompt", value="This model does not have a System Prompt...",lines=1, interactive=False)
